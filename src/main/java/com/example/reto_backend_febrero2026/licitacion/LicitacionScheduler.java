...
public class LicitacionScheduler {
    ...
    public void getLicitacionesByConfig()
    {
        ...
        ArceRssFilters arceRssFilters = new ArceRssFilters(config.getFamilia().getCod(), config.getSubfamilia().getCod());
        this.arceClientService.obtenerLicitaciones(arceRssFilters);
    }
